...
export class LevelSeeder implements SeederInterface {
  ...
  async run(): Promise<void> {
    ...
    const levels = [
      { name: 'Primer Semestre', order: 1 },
      { name: 'Segundo Semestre', order: 2 },
      { name: 'Tercer Semestre', order: 3 },
      { name: 'Cuarto Semestre', order: 4 },
      { name: 'Quinto Semestre', order: 5 },
      { name: 'Sexto Semestre', order: 6 },
      { name: 'Séptimo Semestre', order: 7 },
      { name: 'Octavo Semestre', order: 8 },
      { name: 'Noveno Semestre', order: 9 },
      { name: 'Décimo Semestre', order: 10 },
    ];
